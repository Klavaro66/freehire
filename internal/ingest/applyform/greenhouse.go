...
//
// Deliberately not an internal/platform/flexjson type: that package coerces numerically and exists
...
// internal/candidate/resumeextract's verbatimString, which the flexjson doc points to as the
