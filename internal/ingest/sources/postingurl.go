...
// <tenant>.catsone.com per company, the same shape internal/ingest/atsboard's "catsone"
...
// the same "apex sits somewhere in the middle" test internal/ingest/atsboard's matchHost
