...
// fields both the board adapter (internal/ingest/sources) and the link-following adapter
// (internal/ingest/linksource) need, so the two parse a Habr detail page identically. Description is raw
