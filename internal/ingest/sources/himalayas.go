...
// the literal "name" as the employer. That slug is the same shape internal/dict/companyname
...
// already hold from the company's own ATS (see internal/job/jobhash.RoleFingerprint, which
