...
// provider-agnostic internal/platform/llm client, NOT an autonomous agent: the step count and
...
// dimensions. Pure and I/O-free (mirrors internal/candidate/atscheck / internal/job/verdict).
