...
//
//	LLM_BASE_URL=… LLM_API_KEY=… LLM_MODEL=… go test -tags=llmlive ./internal/candidate/resumeextract/ -run Measure -v
//
...
// pdfText shells out rather than importing internal/candidate/resume, which imports this
...
var fixtures = map[string]string{
	"handler/resume_sample": "../../api/handler/testdata/resume_sample.pdf",
	"resume/canva_cid":      "../../candidate/resume/testdata/canva_cid_identityh.pdf",
}
