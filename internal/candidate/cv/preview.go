...
func sampleDocument() Document {
	return Document{
		...
		Experience: []ExperienceItem{
			{Role: "Senior Software Engineer", Company: "Northwind", Location: "Remote", Start: &perioddate.Date{Year: 2021}, Current: true,
			...
			{Role: "Software Engineer", Company: "Acme Corp", Location: "Berlin", Start: &perioddate.Date{Year: 2017}, End: &perioddate.Date{Year: 2021},
				Bullets: []string{"Built the billing service from scratch, now core revenue infra."},
				Stack:   []string{"Python", "React"}},
		},
		Education: []EducationItem{{Degree: "BSc", Field: "Computer Science", Institution: "State University", Start: &perioddate.Date{Year: 2013}, End: &perioddate.Date{Year: 2017}}},
		Skills: []SkillGroup{
