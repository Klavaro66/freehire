...
func TestSeedMapsStructured(t *testing.T) {
	s := resumeextract.Structured{
		...
		Experience: []resumeextract.Experience{
			{Title: "Senior Engineer", Company: "Analytical Engines", Location: "London", Start: &perioddate.Date{Year: 2018}, Current: true,
		...
		Education: []resumeextract.Education{
			{Degree: "BSc Mathematics", Institution: "Cambridge", Year: &perioddate.Date{Year: 1835}},
		},
	...
	if e.Role != "Senior Engineer" || e.Company != "Analytical Engines" || e.Location != "London" ||
		e.Start == nil || *e.Start != (perioddate.Date{Year: 2018}) || !e.Current {
	...
	if len(doc.Education) != 1 || doc.Education[0].Degree != "BSc Mathematics" ||
		doc.Education[0].End == nil || *doc.Education[0].End != (perioddate.Date{Year: 1835}) {
