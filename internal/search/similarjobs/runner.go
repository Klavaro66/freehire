...
// nearest-neighbour-over-chunks rollup (internal/platform/db's already-built NearestJobsToJob)
...
//
// Unlike internal/ai/embed's semantic_outbox, this worker finds outstanding work with a
...
type RunOptions struct {
	...
	// at least the API's maxSimilarLimit (internal/api/handler, 20 as of this
...
// telagon's cmd/similar-backfill shape), not internal/platform/outbox's RunPool, which
