...
// (mirrors internal/ai/embed's fakeClaimer), then returns empty forever — the shape a
...
type fakeStore struct {
	...
	// (mirrors internal/ai/embed's blockUntilCtxDone-style fixtures).
	arrived chan int64
	release chan struct{}
}
...
// internal/ai/embed's TestRunPool_RunsUpToConcurrencyItemsInParallel.
