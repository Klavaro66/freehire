...
type CompanyDocument struct {
	...
	// internal/platform/db/queries/companies.sql) until that's added deliberately,
...
// Postgres path in internal/api/handler widens the same facet the same way; a test
