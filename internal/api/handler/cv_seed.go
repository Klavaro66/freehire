...
// internal/candidate/cv needs no knowledge of the bank at all: it keeps receiving a Structured and
...
// has rows. See internal/candidate/resume/AGENTS.md for the identity table.
