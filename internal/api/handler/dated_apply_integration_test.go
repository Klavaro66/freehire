...
// Postgres. The pieces are unit-tested apart — the window in internal/application/userjob, the routing in
// user_jobs_test.go, the re-dating statement in internal/platform/db — but the transaction that runs
