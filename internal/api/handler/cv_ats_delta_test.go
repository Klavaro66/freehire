...
func TestScoreRenderedCV_AFieldTheTemplateDropsDoesNotScore(t *testing.T) {
	...
	doc := cv.Document{
		...
		Education: []cv.EducationItem{{Degree: "BSc Mathematics", Institution: "Cambridge", Start: &perioddate.Date{Year: 2010}, End: &perioddate.Date{Year: 2014}}},
		Skills:    []cv.SkillGroup{{Group: "Languages", Items: []string{"Go", "Python", "SQL"}}},
		Certifications: []cv.Certification{
			{Name: "Certified Kubernetes Administrator", Issuer: "CNCF", Year: &perioddate.Date{Year: 2023}},
		},
	}
