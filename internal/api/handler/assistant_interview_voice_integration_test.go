...
// to the session transcript. Run with: go test -tags=integration ./internal/api/handler/
package handler
...
// realtimeStub stands in for internal/api/realtime.Client. It records the instructions it
