...
//
// It holds the profile assembler (internal/candidateprofile — the same one cmd/auto-apply
...
// autofillProfile assembles a user's canonical autofill fields via internal/candidateprofile.
