...
// named and commented to mark the difference: internal/ai/enrich (stringOrFirst /
...
// internal/candidate/resumeextract (verbatimString — a bare scalar kept as written, not coerced;
