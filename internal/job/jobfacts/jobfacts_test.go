...
func TestEducationLevel(t *testing.T) {
	cases := []struct{ name, desc, want string }{
		...
		{"master preferred is not required", "A Master's degree is preferred.", ""},
		{"mba plus is not required", "An MBA is a plus.", ""},
		{"phd", "PhD in Machine Learning required.", "phd"},
		{"phd dotted", "Ph.D. or equivalent research experience.", "phd"},
		{"required bachelor beats preferred phd", "Bachelor's required, PhD preferred.", "bachelor"},
		...
		{"hungarian bachelor bsc", "Szakirányú BSc végzettség szükséges.", "bachelor"},
		{"hungarian higher education", "Felsőfokú végzettség szükséges.", "bachelor"},
		{"hungarian university degree", "Egyetemi végzettség elvárás.", "bachelor"},
		{"hungarian college degree", "Főiskolai végzettség szükséges.", "bachelor"},
		{"hungarian master", "Mesterfokú végzettség szükséges.", "master"},
		{"hungarian msc preferred is not required", "MSc végzettség előnyt jelent.", ""},
		{"hungarian phd", "Doktori fokozat szükséges.", "phd"},
		{"hungarian secondary school is not bachelor", "Középiskolai végzettség szükséges.", ""},
		{"hungarian preferred bachelor ignored", "Legalább középiskolai végzettség szükséges. Felsőfokú végzettség előnyt jelent.", ""},
		{"hungarian preferred master does not override required bachelor", "Felsőfokú végzettség szükséges. Mesterfokú végzettség előnyt jelent.", "bachelor"},
		{"hungarian profession preferred section ignored", `<p>Az álláshoz tartozó elvárások:</p>Felsőfokú végzettség szükséges.<p>Az állás betöltéséhez előnyt jelent:</p>Mesterfokú végzettség.`, "bachelor"},
		{"hungarian preferred section alone produces no education", `<p>Az álláshoz tartozó elvárások:</p>Középiskolai végzettség.<p>Az állás betöltéséhez előnyt jelent:</p>Felsőfokú végzettség.`, ""},
	}
	for _, c := range cases {
		t.Run(c.name, func(t *testing.T) {
...
func TestEnglishLevel(t *testing.T) {
	cases := []struct{ name, desc, want string }{
		...
		// Phrase levels (HU).
		{"hungarian b2 explicit", "Legalább B2 szintű angol nyelvtudás szükséges.", "b2"},
		{"hungarian b2 forward", "Angol nyelvtudás minimum B2 szinten.", "b2"},
		{"hungarian intermediate", "Középfokú angol nyelvtudás szükséges.", "b2"},
		{"hungarian intermediate reversed", "Angol középfokú nyelvtudás szükséges.", "b2"},
		{"hungarian advanced", "Felsőfokú angol nyelvtudás szükséges.", "c1"},
		{"hungarian fluent", "Folyékony angol nyelvtudás.", "c1"},
		{"hungarian negotiation level", "Tárgyalóképes angol nyelvtudás.", "c1"},
		{"hungarian basic", "Alapfokú angol nyelvtudás elegendő.", "a2"},
		{"hungarian no english", "Angol nyelvtudás nem szükséges.", "none"},
		// Regression cases from real Hungarian postings. Explicit English requirements
		// must win over qualitative wording and levels belonging to another language.
		{"hungarian explicit intermediate beats conversational wording", "Erős középfokú, társalgási szintű angol nyelvtudás.", "b2"},
		{"hungarian intermediate beats negotiation wording", "Középfokú, tárgyalóképes angol nyelvtudás.", "b2"},
		{"hungarian conversational not confused with education", "Felsőfokú végzettség szükséges. Angol - társalgási szint.", "b1"},
		{"german c1 does not override english b1", "German language proficiency at least B2+, C1 level. English language proficiency at least B1 level.", "b1"},
		{"english c1 not confused with german b2", "Strong communication skills in English (C1) and German (min. B2).", "c1"},
		{"hungarian basic not confused with german intermediate", "Német nyelvtudás min. középfokon. Angol nyelvtudás min. alapfokon.", "a2"},
		// Preferred/optional English requirements must not become hard constraints.
		{"hungarian preferred english ignored", "Angol nyelvtudás előnyt jelent.", ""},
		{"hungarian preferred c1 does not override required b2", "Középfokú angol nyelvtudás szükséges, felsőfokú angol nyelvtudás előnyt jelent.", "b2"},
		{"hungarian profession preferred english section ignored", `<p>Az álláshoz tartozó elvárások:</p>Középfokú angol nyelvtudás.<p>Az állás betöltéséhez előnyt jelent:</p>Felsőfokú angol nyelvtudás.`, "b2"},
		{"hungarian preferred english section alone produces no level", `<p>Az álláshoz tartozó elvárások:</p>Precíz munkavégzés.<p>Az állás betöltéséhez előnyt jelent:</p>C1-es angol nyelvtudás.`, ""},
