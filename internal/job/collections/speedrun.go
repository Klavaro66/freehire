...
// speedrunSourceTag identifies us to the API, matching internal/ingest/sources/speedrun.go.
...
// JSON API — the same one internal/ingest/sources/speedrun.go crawls for roles. It is the
