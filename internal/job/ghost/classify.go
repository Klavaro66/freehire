...
//
// Like internal/job/jobreality it is a pure classifier over scalars — no database, no
...
// the first offending one, matching internal/application/userjob's silence ladder.
