...
import "github.com/strelov1/freehire/internal/application/userjob"
...
// MOVE from one stage to another is a tracking rule, and internal/application/userjob owns it along with the
