...
//
// It is not a method on internal/application/jobtracking. That package is organised around mutations
...
//
// The rules live here rather than in the Fiber handler for the reason internal/application/inbox
