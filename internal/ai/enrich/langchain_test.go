...
// The per-call timeout / generate / choices behavior now lives in internal/platform/llm
...
// deterministic dictionaries (internal/job/jobderive), so the LLM's copies are never
