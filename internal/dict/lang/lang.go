...
// emits "" rather than guessing, the same doctrine as internal/dict/location and
// internal/dict/classify.
package lang
...
func Detect(text string) string {
	...
	// guess), matching the doctrine of internal/dict/location and internal/dict/classify.
