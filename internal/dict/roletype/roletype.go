...
// It is a curated dictionary, not a model — the same doctrine as internal/dict/classify,
// internal/dict/roletag and internal/dict/skilltag: it emits the canonical value for what it
