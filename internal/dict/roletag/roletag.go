...
// dictionary, not a model — the same doctrine as internal/dict/classify and
// internal/dict/skilltag: it emits canonical role slugs for what it can resolve and
...
var namedRoleTable = []struct {
	...
	// category (see internal/dict/classify) but is its own craft. Only the phrase resolves:
