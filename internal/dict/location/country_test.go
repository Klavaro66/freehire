...
func TestNormalizeCountry(t *testing.T) {
	cases := []struct {
		...
		{"plain country name (Ashby, some employer configs)", "United States", "us"},
		{"plain country name, different country", "Germany", "de"},
		{"country name outside the curated region set", "Afghanistan", ""},
		{"padded", "  gb  ", "gb"},
		{"empty", "", ""},
