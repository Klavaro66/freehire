...
export const ROLE_ALIASES = {
  ...
  'recruiting': ['it recruiter', 'recruiter', 'recruitment consultant', 'recruitment specialist', 'talent acquisition', 'talent sourcer', 'tech recruiter', 'technical recruiter', 'рекрутер', 'рекрутёр', 'специалист по подбору персонала'],
  'research_engineer': ['research engineer'],
  ...
  'technical_writing': ['content designer', 'content strategist', 'documentation engineer', 'documentation manager', 'documentation specialist', 'information developer', 'localization manager', 'localization specialist', 'technical communicator', 'technical writer', 'technical writing', 'ux writer', 'ux-редактор', 'разработчик документации', 'специалист по документации', 'технический писатель', 'технический редактор', 'техписатель'],
